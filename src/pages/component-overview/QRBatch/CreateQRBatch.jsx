...
import {
    Select, InputNumber, Input, DatePicker, Button, message, Tooltip
} from 'antd';
...
const CreateQRBatch = () => {
    ...
    const handlePrint = () => {
        ...
        previewData.serials.forEach((serial) => {
            ...
            ${cfg.showValidity && serial.validityDate ? `<div class="d-row"><span class="dk">VALID TILL:</span><span class="dv">${dayjs(serial.validityDate).format('DD MMM YYYY')}</span></div>` : ''}
        `;
